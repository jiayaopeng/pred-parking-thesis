...
def load_seattle(target_areas, source_areas, include_pbp, bucket, sm_mode):
    ...
    # select the same 22 features as for baseline and clustering
    features = ['length', 'current_capacity', 'tempC', 'windspeedKmph', 'precipMM',
                'highway', 'hour', 'weekday', 'commercial_100', 'residential_100',
                'transportation_100', 'schools_100', 'eventsites_100',
